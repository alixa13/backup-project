...
/**
 * Unsupervised Flink Kafka Consumer for SSL logs
 ...
 * Total: 33 features
 */
public class UnsupervisedFlinkKafkaConsumerSSLImproved {
    private static final Logger LOGGER = Logger.getLogger(UnsupervisedFlinkKafkaConsumerSSLImproved.class.getName());
    ...
    private static void updateThreshold() {
        synchronized (UnsupervisedFlinkKafkaConsumerSSLImproved.class) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        consumerProps.setProperty("group.id", "unsupervised-ssl-improved-consumer-group");
                ...
                .process(new ProcessFunction<JsonNode, String>() {
                    ...
                    public void processElement(JsonNode logEntry, Context ctx, Collector<String> out) throws Exception {
                        ...
                        try {
                            ...
                            if (sslData == null || sslData.isNull()) return;

                            JsonNode orig = sslData.get("id.orig_h");
                            ...
                            double[] features = PREPROCESSOR.buildRawVector(sslData);
                            ...
                            LOGGER.log(Level.WARNING, "Error processing SSL log entry: " + entryStr + " - " + msg, e);
                        }
                    }
                })
