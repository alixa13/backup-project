...
public class UnsupervisedFlinkKafkaConsumerHTTPImproved {
    private static final Logger LOGGER = Logger.getLogger(UnsupervisedFlinkKafkaConsumerHTTPImproved.class.getName());
    ...
    private static void updateThreshold() {
        synchronized (UnsupervisedFlinkKafkaConsumerHTTPImproved.class) {
                ...
                .process(new ProcessFunction<JsonNode, String>() {
                    ...
                    public void processElement(JsonNode logEntry, Context ctx, Collector<String> out) throws Exception {
                        ...
                        try {
                            ...
                            if (httpData == null || httpData.isNull()) return;

                            JsonNode orig = httpData.get("id.orig_h");
                            ...
                            double[] features = PREPROCESSOR.buildRawVector(httpData);
                            ...
                            LOGGER.log(Level.WARNING, "Error processing HTTP log entry: " + entryStr + " - " + msg, e);
                        }
                    }
                })
